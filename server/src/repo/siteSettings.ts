...
interface SiteSettingsRow {
  ...
  max_challenge_beatmaps: number | null;
...
const COLUMNS = `min_stars, max_stars, min_length_seconds, max_length_seconds,
                 ...
                 max_challenge_beatmaps, max_submissions_per_user, updated_by, updated_at`;
...
function toSettings(row: SiteSettingsRow): SiteSettings {
  return {
    ...
    maxChallengeBeatmaps: row.max_challenge_beatmaps,
...
const PATCH_COLUMNS: Record<keyof SiteSettingsPatch, string> = {
  ...
  maxChallengeBeatmaps: 'max_challenge_beatmaps',
